...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \begin{scope}[shift={($(current page.south west)+(\marginx,\marginy)$)}]
    ...
    % Clip slant guidelines at x margins
    \clip     (          0,            -\marginy)
