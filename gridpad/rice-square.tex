...
\tikzset{
  ...
  stamp minorlineh/.style = {
      ...
      dash phase=0.5*\stampwidth/3/2/2 %1.5 also looks good
    },
  stamp minorlinev/.style = {
      ...
      dash phase=0.5*\stampheight/3/2/2 %1.5 also looks good
    },
  stamp minorlined/.style = {
      ...
      dash phase=1.5*\stampdiagonal/4/2/2 %0.5 also looks good
    },
  pics/stamp/.style={
      code={
          % Horizontal
