...
\tikzset{
  ...
  stamp minorlineh/.style = {
      ...
      line cap=butt,
      line width=0.15mm,
      dash pattern=on \stampwidth/3/2/2 off \stampwidth/3/2/2,
      dash phase=0.5*\stampwidth/3/2/2 % alternative: 1.5
    },
  stamp minorlinev/.style = {
      stampcolorb,
      line cap=butt,
      line width=0.15mm,
      dash pattern=on \stampheight/3/2/2 off \stampheight/3/2/2,
      dash phase=0.5*\stampheight/3/2/2 % alternative: 1.5
    },
  stamp minorlined/.style = {
      stampcolorb,
      line cap=butt,
      line width=0.15mm,
      dash pattern=on \stampdiagonal/4/2/2 off \stampdiagonal/4/2/2,
      dash phase=1.5*\stampdiagonal/4/2/2 % alternative: 0.5
    },
  pics/stamp/.style={
      code={
          % Horizontal
          ...
          % Diagonal
          \draw [stamp minorlined] (0,0) -- (\stampwidth,\stampheight);
          \draw [stamp minorlined] (0,\stampheight) -- (\stampwidth,0);
          % Horizontal
