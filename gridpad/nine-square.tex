...
\providecolor{stampcolora}{cmyk:named}{magenta!30}
\providecolor{stampcolorb}{cmyk:named}{cyan!30}
...
\tikzset{
  ...
  stamp minorlineh/.style = {
      ...
      dash phase=0.5*\stampwidth/3/3/2 %1.5 also looks good
    },
  stamp minorlinev/.style = {
      ...
      dash phase=0.5*\stampheight/3/3/2 %1.5 also looks good
    },
  pics/stamp/.style={
      code={
          % Horizontal
